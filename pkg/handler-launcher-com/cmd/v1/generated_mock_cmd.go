...
func (_m *MockCmdClient) CreateSnapshotVirtualMachine(ctx context.Context, in *VMIRequest, opts ...grpc.CallOption) (*Response, error) {
	_s := []interface{}{ctx, in}
	for _, _x := range opts {
		_s = append(_s, _x)
	}
	ret := _m.ctrl.Call(_m, "CreateSnapshotVirtualMachine", _s...)
	ret0, _ := ret[0].(*Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockCmdClientRecorder) CreateSnapshotVirtualMachine(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	_s := append([]interface{}{arg0, arg1}, arg2...)
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateSnapshotVirtualMachine", _s...)
}
...
func (_m *MockCmdServer) CreateSnapshotVirtualMachine(_param0 context.Context, _param1 *VMIRequest) (*Response, error) {
	ret := _m.ctrl.Call(_m, "CreateSnapshotVirtualMachine", _param0, _param1)
	ret0, _ := ret[0].(*Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockCmdServerRecorder) CreateSnapshotVirtualMachine(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateSnapshotVirtualMachine", arg0, arg1)
}
